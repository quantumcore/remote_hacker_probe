...
const char* Network::IP2Host(const char* IP)
{
...
void Network::CheckHost(const char* ip_address)
{
    DWORD ret;
    IPAddr srcip = 0;
    ULONG MacAddr[2];
...
void Network::checkPort(const char* ip, int port)
{
    SOCKET connectsock;
...
void Network::EternalBlueScan(const char* host)
{
    char output[BUFFER];
    do {
        int len = 0;
